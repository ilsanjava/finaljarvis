...
<html lang="en">
  <head>
    ...
    <style>
		.header{background:#005B66; color:#fff;}
	...
	<section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
               <a href="index.php" class="logo"><b><?php echo $toko['nama_toko'];?></b> <small style="padding-left:20px;font-size:13px;"><?php echo $toko['alamat_toko'];?></small></a> 
            <!--logo end-->
         ...
         <div class="top-menu">
              <ul class="nav pull-right top-menu"> 
                    <li><td align="center">
                      <img src="assets/img/logoteko.png" width="78" height="55" />
                          </td></a></li>
              </ul>
            </div>
            <div class="top-menu">
