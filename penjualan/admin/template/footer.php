   <!--main content end-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              <font face="arial" color="gray">TECKO LASER ADMIN</font>  
              &copy; <a href="http://tkjsegar.online" style="color:lightblue; font-weight:700;" target="tkjsegar.online">tkjsegar.online</a> <?php echo date('Y');?> 
              <a href="#" class="go-top">
